        ...
        <div class="offcanvas-lg offcanvas-end flex-grow-1" tabindex="-1" id="bdNavbar"
            ...
            <div class="offcanvas-body p-4 pt-0 p-lg-0">
                ...
                <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav">
                    ...
                    <li class="nav-item col-6 col-lg-auto">
                        <a class="nav-link py-2 px-0 px-lg-2" href="<?= link_to('blog') ?>" target="_blank"
                            rel="noopener">Blog</a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                    <li class="nav-item col-6 col-lg-auto">
                        <a class="nav-link py-2 px-0 px-lg-2" href="https://github.com/blitz-php" target="_blank"
                            rel="noopener">
                    ...
                    <li class="nav-item col-6 col-lg-auto">
                        <a class="nav-link py-2 px-0 px-lg-2" href="https://twitter.com/blitzphp" target="_blank"
                            rel="noopener">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="navbar-nav-svg"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a href="<?= link_to('docs.version', $k, trim($currentSection ?: 'installation', '/')) ?>"
                                    class="dropdown-item d-flex align-items-center justify-content-between <?= $k === $currentVersion ? 'active' : '' ?>">
                                    <?= $v ?>
                            ...
                            <li>
                                <a class="dropdown-item" href="<?= link_to('goto', 'versions') ?>">Toutes les
                                    versions</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a href="<?= link_to('lang', $k) ?>"
                                    class="dropdown-item d-flex align-items-center justify-content-between <?= $k == $currentLanguage ? 'active' : '' ?>">
                                    <?= $v ?>
